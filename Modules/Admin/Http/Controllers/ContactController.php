...
class ContactController extends Controller
{
    ...
    {   
        $page_title = "Contact";
         ...
         $data = Contact::where('is_deleted',0)->latest()->get();
         return Datatables::of($data)
                           ...
                           //  })
                            ...
                            //     return $btn;
                            // })
                            ->rawColumns(['image','message','action'])
                            ->make(true);
        }

        return view('admin::contacts.index',compact('page_title'));
    }
    ...
    public function create()
    {
        ...
        return view('admin::contacts.create',compact('page_title'));
    }
