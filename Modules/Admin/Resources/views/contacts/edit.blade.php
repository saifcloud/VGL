            ...
            <div class="row clearfix">
                <div class="col-md-12">
                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            <form id="basic-form" method="post" action="{{ url('admin/testimonial/update')}}" enctype="multipart/form-data">
                               @csrf
                                ...
                                <input type="hidden" name="id" value="{{ base64_encode($data->id)}}">
                                  ...
                                  <div class="row col-sm-12 justify-content-center">
                                    ...
                                    <div class="form-group col-sm-4">
                                      ...
                                      <!--  <img src="{{ url('public/images/news/'.$data->image)}}" width="300" height="150"
                                       class="image"> -->
